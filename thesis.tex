...
Tato práce se zabývá vývojem dialogového systému v angličtině, který je založený na systému Alex vyvíjeným na Ústavu formální a aplikované lingvistiky.
...
Dialogový systém byl přihlášen do soutěže MTA App Quest 2014.
...
Abstract:
This paper presents a phone-based spoken dialogue system developed within Alex dialogue system framework in python.
...
The dialogue system attended the 2014 MTA App Quest challenge.
