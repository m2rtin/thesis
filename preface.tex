...
%The interface is intuitive, direct and hands-free, which renders an opportunity for deployment in many fields.
...
The comparison measures will be based on the Crowdflower contributor's testimony. % deliberation testimony
...
In the fifth chapter we will draw conclusions and summarize the \todo{word} encountered in the process.
